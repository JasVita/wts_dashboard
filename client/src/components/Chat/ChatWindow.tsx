  ...
  const handleSave = async () => {
    ...
    try {
      ...
      for (const labelId of addedLabels) {
        await axios.patch(`${process.env.NEXT_PUBLIC_API_URL}/customers/assignLabel/${labelId}`, {
      ...
      for (const labelId of removedLabels) {
        await axios.patch(`${process.env.NEXT_PUBLIC_API_URL}/customers/removeLabel/${labelId}`, {
